...
import {
    ChatBubbleLeftRightIcon, MinusIcon, 
...
export const LoungeChatWidget = () => { // Nome do componente alterado para evitar conflito se estiver no mesmo escopo
    ...
    const [chatHistory, setChatHistory] = useState<Message[]>([
        { id: 1, sender: "them", text: "Hello! I saw you are studying the Bio-tech modules.", time: "10:00" },
        { id: 2, sender: "me", text: "Yes! I'm fascinated by the Zaeon project.", time: "10:02" }
    ]);
    ...
    const handleSendMessage = (e?: React.FormEvent) => {
        ...
        setTimeout(() => {
            setChatHistory((prev) => [...prev, {
                id: Date.now() + 1,
                sender: "them",
                text: "That sounds interesting. Shall we collaborate on the next paper?",
                time: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })
            }]);
        }, 2000);
    };
            ...
            >
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-black uppercase tracking-widest text-white">
                        {isOpen ? (selectedUser ? selectedUser.name : "Zaeon Messenger") : "Online Chat (4)"}
                    </span>
                </div>
                        ...
                        {activeView === "list" && (
                            <>
                                ...
                                <div className="px-4 py-2 relative">
                                    ...
                                    <input type="text" placeholder="Search researcher..." className="w-full bg-slate-100 dark:bg-white/5 rounded-full py-1.5 pl-8 pr-4 text-xs outline-none dark:text-white" />
                                </div>
                                        ...
                                        >
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-[10px] text-slate-400 group-hover:text-[#0f172a] dark:group-hover:text-white transition-colors">
                                                    {user.status === 'online' ? 'Online now' : 'Last seen 2h ago'}
                                                </p>
                                            </div>
                                        </div>
                                    ))}
